...
[
  ...
  { id: 2113, type: 'choice', topic: '图论', difficulty: 'medium', question: '（原图已转文字）6顶点有向图含边：1→2, 1→3, 2→3, 3→4, 4→1, 4→5, 5→6。该图含环1→3→4→1，无法拓扑排序。删除一条边打破该环使其可拓扑排序，有多少条候选边？', code: null, options: [{key:'A',text:'1'},{key:'B',text:'2'},{key:'C',text:'3'},{key:'D',text:'4'}], answer: ['C'], explanation: '环为1→3→4→1，三条边均可删除打破环：1→3, 3→4, 4→1，共3条候选边。' },
  { id: 2114, type: 'choice', topic: '数学基础', difficulty: 'medium', question: '十六进制数n的各位数字之和记为f(n)，若f(n)仍为多位则继续迭代，直至一位数（不动点）。在十六进制数100~1A0范围内，不动点为9的数有多少个？', code: null, options: [{key:'A',text:'10'},{key:'B',text:'11'},{key:'C',text:'12'},{key:'D',text:'13'}], answer: ['B'], explanation: '直接满足f(n)=9的有9个（108,117,126,135,144,153,162,171,180），满足f(f(n))=9的有2个（1E9,1F8），共11个。' },
