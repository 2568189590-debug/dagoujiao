...
[
  ...
  { id: 4235, type: 'fill', topic: '二分查找', difficulty: 'hard', question: '(35)②处应填（）。', code: null, options: [{key:'A',text:'a1[m1]==a2[m2]'},{key:'B',text:'a1[m1]<=a2[m2]'},{key:'C',text:'a1[m1]>=a2[m2]'},{key:'D',text:'a1[m1]!=a2[m2]'}], answer: ['B'], explanation: '比较a1[m1]与a2[m2]的大小，决定收缩哪个数组的区间。' },
  { id: 4236, type: 'fill', topic: '二分查找', difficulty: 'hard', question: '(36)③处应填（）。', code: null, options: [{key:'A',text:'left1>right1'},{key:'B',text:'left2>right2'},{key:'C',text:'left1<right1'},{key:'D',text:'left2<right2'}], answer: ['B'], explanation: 'if分支从a1取答案，说明a2已被完全排除（left2>right2），故③填left2>right2。' },
  { id: 4237, type: 'fill', topic: '二分查找', difficulty: 'hard', question: '(37)④处应填（）。', code: null, options: [{key:'A',text:'y=a1[k-left2-1]'},{key:'B',text:'y=a2[k-left1-1]'},{key:'C',text:'y=a2[k-left1]'},{key:'D',text:'y=a1[k-left2]'}], answer: ['B'], explanation: 'else分支对应a1被排除(left1>right1)，答案在a2中，为第(k-left1)个元素，下标k-left1-1。' },
...
FILL_SECTIONS.push(
  { label: '2022一·归并第k小', ids: [4234,4235,4236,4237], year: '2022' },
